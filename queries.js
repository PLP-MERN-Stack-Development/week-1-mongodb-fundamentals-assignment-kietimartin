...
// Sorting the books by price both acscending and decending
...
db.books.aggregate([{$group: {_id: {$subtract: ["$published_year", {$mod: ["$published_year", 10]}]},BooksInDecade: {$sum: 1}}}, {$sort: {_id:1}}]);
